...
/*!**************************************************!*\
  !*** ./src/handlers/schedule/get_one/handler.ts ***!
  \**************************************************/
...
const handler = function (event) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const schedule = new schedule_1.Schedule({ id: id });
        const dynamoRepository = DynamoScheduleRepository_1.DynamoScheduleRepository.getInstance();
        const scheduleExists = yield (dynamoRepository === null || dynamoRepository === void 0 ? void 0 : dynamoRepository.getOne(schedule.id));
        if (!(scheduleExists === null || scheduleExists === void 0 ? void 0 : scheduleExists.Item)) {
            throw new badId_1.BadIDError('Schedule with the provided id as a path parameter does not exist.');
        }
        return {
            statusCode: 200,
            body: JSON.stringify(scheduleExists, null, 2),
        };
    });
};
