...
/*!*********************************************!*\
  !*** ./src/handlers/user/delete/handler.ts ***!
  \*********************************************/
...
const handler = function (event) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        if (!id) {
            throw new badRequest_1.BadRequestError('Please supply id as a path parameter.');
        }
        const user = new user_1.User({ id: id });
        const dynamoRepository = DynamoUserRepository_1.DynamoUserRepository.getInstance();
        const result = yield (dynamoRepository === null || dynamoRepository === void 0 ? void 0 : dynamoRepository.delete(user.id));
        return {
            statusCode: 200,
