...
const handler = function (event) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        if (payload.userId) {
            ...
            try {
                const userExists = yield user.getOne();
                if (!userExists.id) {
        ...
        const existingScheduleItem = yield schedule.getOne();
        if (!existingScheduleItem.id) {
        ...
        const updateSchedule = new schedule_1.Schedule({
            id: existingScheduleItem.id,
            userId: payload.userId || existingScheduleItem.userId,
            dateTime: payload.dateTime || existingScheduleItem.dateTime,
            description: payload.description || existingScheduleItem.description,
            duration: payload.duration || existingScheduleItem.duration,
            eventTitle: payload.eventTitle || existingScheduleItem.eventTitle,
            eventType: payload.eventType || existingScheduleItem.eventType,
        });
        yield updateSchedule.update();
        return {
            statusCode: 200,
