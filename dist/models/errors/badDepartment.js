...
/*!********************************************!*\
  !*** ./src/models/errors/badDepartment.ts ***!
  \********************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BadDepartmentError = void 0;
const customError_1 = __webpack_require__(/*! ./customError */ "./src/models/errors/customError.ts");
class BadDepartmentError extends customError_1.CustomError {
    constructor(message) {
        super(message);
        this.statusCode = 400;
    }
...
exports.BadDepartmentError = BadDepartmentError;
