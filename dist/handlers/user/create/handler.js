...
/***/ "./src/models/errors/badUsername.ts":
/*!******************************************!*\
  !*** ./src/models/errors/badUsername.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BadUsernameError = void 0;
const customError_1 = __webpack_require__(/*! ./customError */ "./src/models/errors/customError.ts");
class BadUsernameError extends customError_1.CustomError {
    constructor(message) {
        super(message);
        this.statusCode = 400;
    }
...
/*!*********************************************!*\
  !*** ./src/handlers/user/create/handler.ts ***!
  \*********************************************/
...
const handler = function (event) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        if (!event) {
            throw new badRequest_1.BadRequestError('Bad request, there is no body.');
        }
        ...
        const result = yield user.putInDB();
        return {
            statusCode: 201,
