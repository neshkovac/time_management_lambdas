...
/*!*************************************************!*\
  !*** ./src/handlers/schedule/delete/handler.ts ***!
  \*************************************************/
...
const handler = function (event) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const result = yield (dynamoRepository === null || dynamoRepository === void 0 ? void 0 : dynamoRepository.delete(schedule.id));
        if (!result) {
            throw new badId_1.BadIDError('Id provided as a path parameter does not match any of the schedules in the schedule-table');
        }
        return {
            statusCode: 200,
