...
const handler = function (event) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const existingUser = yield (userDynamoRepository === null || userDynamoRepository === void 0 ? void 0 : userDynamoRepository.getOne(user.id));
        if (!(existingUser === null || existingUser === void 0 ? void 0 : existingUser.Item)) {
        ...
        const result = yield (scheduleDynamoRepository === null || scheduleDynamoRepository === void 0 ? void 0 : scheduleDynamoRepository.create(schedule));
        return {
            statusCode: 201,
